...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-mp_jhth2%)k=!h)6(qemwois^3@eh0ml*u21$@8=c#-rx&s@xy')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DJANGO_DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['*']  # For Docker, you can use '*' or specific hosts
